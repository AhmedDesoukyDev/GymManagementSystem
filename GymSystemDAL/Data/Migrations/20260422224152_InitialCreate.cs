        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailFormat", "Email like '_%@_%._%'");
                    table.CheckConstraint("PhoneFormat", "PhoneNumber like '01%' and PhoneNumber Not Like '%[^0-9]%' ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("DurationDaysRange", "DurationDays between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailFormat1", "Email like '_%@_%._%'");
                    table.CheckConstraint("PhoneFormat1", "PhoneNumber like '01%' and PhoneNumber Not Like '%[^0-9]%' ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberShips", x => new { x.MemberId, x.SessionId });
                    table.ForeignKey(
